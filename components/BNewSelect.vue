...
<template>
  <div class="relative w-full">
    ...
    <button
      ...
      class="w-full px-4 py-3 text-left mt-[0.15rem] rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-zinc-700 text-gray-700 dark:text-white focus:outline-none focus:border-gray-300 focus:ring focus:ring-gray-300"
    >
